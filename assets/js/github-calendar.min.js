...
!function (e) {
    ...
    return function o(s, u, i) {
        ...
        1: [function (e, t, r) {
            var m = e("github-calendar-parser"), g = e("elly"), h = e("add-subtract-date"), y = e("formatoid"),
                M = "MMM D, YYYY", v = "MMMM D";
            ...
            t.exports = function (p, e, b) {
                ...
                return function f() {
                    return fetch(b.proxy("https://github.com/users/" + e + "/contributions")).then(function (e) {
                        ...
                        if (g(".position-relative h2", r).remove(), r.querySelector(".float-left.text-gray").innerHTML = b.summary_text, r.querySelector("include-fragment")) setTimeout(f, 500); else {
                            if (!0 === b.responsive) {
                                var n = r.querySelector("svg.js-calendar-graph-svg"), a = n.getAttribute("width"),
            ...
            var n = e("months"), a = e("days"), o = e("fillo"), s = e("parse-it").Parser, u = {
                YYYY: function (e, t) {
            ...
            t.exports = function (e) {
                ...
                return e.split("\n").slice(2).map(function (e) {
                    ...
                    var t = e.match(/fill="(#[a-z0-9]+)"/), r = e.match(/data-date="([0-9\-]+)"/),
                        n = e.match(/data-count="([0-9]+)"/);
                    if (t = t && t[1], r = r && r[1], n = n && +n[1], t) {
                        var a = {fill: t, date: new Date(r), count: n, level: i.indexOf(t)};
            ...
            t.exports = function (e, t) {
                var r = 0, n = [];
                if (Array.isArray(e)) for (; r < e.length && !1 !== t(e[r], r, e); ++r) ; else if ("object" === (void 0 === e ? "undefined" : _typeof(e)) && null !== e) for (n = Object.keys(e); r < n.length && !1 !== t(e[n[r]], n[r], e); ++r) ;
            }
        }, {}], 10: [function (e, t, r) {
